...
class GameInfo:
    def __init__(self):
        ...
        self.ApiKey: str = "OC|27049580084726279|fac5b54e8517cb08a06cdf0232cc862f" # App Api Key
...
def titledata():
    response_data = {
        ...
        "BundleBoardSign": "<color=#ff4141>DISCORD.GG/TREETAGGERS</color>",
        "BundleKioskButton": "<color=#ff4141>DISCORD.GG/TREETAGGERS</color>",
        "BundleKioskSign": "<color=#ff4141>DISCORD.GG/TREETAGGERS</color>",
        "BundleLargeSign": "<color=#ff4141>DISCORD.GG/TREETAGGERS</color>",
        ...
        "MOTD": "<color=red>WELCOME TO CAT TAGGERS!</color>\n<color=yellow>OWNER IS SPIDERRR AND 4XMODZ</color>\n<color=lime>DEVELOPER IS SPIDERR</color>\n<color=blue>https://discord.gg/5Hrm9cjxU</color>",
        ...
        "TOBDefPurchaseBtnDefTxt": "CAT TAGGERS",
        "UseLegacyIAP": False
...
def GetNameIg():
    return jsonify({"result": f"TREE{random.randint(1000,9999)}"})
